...
echo "2. 将 deploy/bot_api.service 复制到 /etc/systemd/system/ 并启动"
echo "3. 将 deploy/nginx.conf 的内容补充到 /etc/nginx/sites-available/default 中"
echo "4. 重启 Nginx 和 Systemd 服务"
